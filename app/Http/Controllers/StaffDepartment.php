...
class StaffDepartment extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $data->detali=$request->detali;
        $data->save();

        return redirect('admin/department/create')->with('success','Data added successfully.');
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect('admin/department/'.$id.'/edit')->with('success','Data updated successfully.');
    }
