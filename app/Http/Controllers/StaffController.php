...
class StaffController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('admin/staff/create')->with('success','Data added successfully.');
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect('admin/staff/'.$id.'/edit')->with('success','Data updated successfully.');
    }
    ...
    function save_payment(Request $request,$staff_id){
        ...
        return redirect('admin/staff/payment/'.$staff_id.'/add')->with('success','Data added successfully.');
    }
