...
class RoomtypeController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('admin/roomtype/create')->with('success','Data added successfully.');
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect('admin/roomtype/'.$id.'/edit')->with('success','Data updated successfully.');
    }
