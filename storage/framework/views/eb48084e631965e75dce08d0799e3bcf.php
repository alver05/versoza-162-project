                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" method="post" action="<?php echo e(url('admin/login')); ?>">
                                        ...
                                        <div class="form-group">
                                            <input name="password" <?php if(Cookie::has('adminpwd')): ?> value="<?php echo e(Cookie::get('adminuser')); ?>" <?php endif; ?> type="password" class="form-control form-control-user"
...
</html><?php /**PATH C:\laragon\www\resortproject\resources\views/login.blade.php ENDPATH**/ ?>