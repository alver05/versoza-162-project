        ...
        <div class="table-responsive">
            <form method="post" action="<?php echo e(url('admin/department/'.$data->id)); ?>">
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        <th>Detail</th>
                        <td><textarea name="detali" class="form-control"><?php echo e($data->detali); ?></textarea></td>
                    </tr>
                    <tr>
                        <td colspan="2">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\resortproject\resources\views/department/edit.blade.php ENDPATH**/ ?>