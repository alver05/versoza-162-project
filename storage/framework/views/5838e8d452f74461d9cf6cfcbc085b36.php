        ...
        <div class="table-responsive">
            <form method="post" action="<?php echo e(url('admin/department')); ?>">
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        <th>Detail</th>
                        <td><textarea name="detali" class="form-control"></textarea></td>
                    </tr>
                    <tr>
                        <td colspan="2">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\resortproject\resources\views/department/create.blade.php ENDPATH**/ ?>