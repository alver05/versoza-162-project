    ...
    $(document).ready(function(){
        $(".delete-image").on('click',function(){
            ...
            $.ajax({
                ...
                dataType:'json',
                beforeSend:function(){
                    _vm.addClass('diasbled');
                },
                success:function(res){
                    if(res.bool==true){
                        $(".imgcol"+_img_id).remove();
                    }
                    _vm.removeClass('diasbled');
                }
            })
        });
    });
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\resortproject\resources\views/roomtype/edit.blade.php ENDPATH**/ ?>