...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Update Personal Information
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="department_id" class="form-control">
                                ...
                                <option <?php if($data->id==$dp->id): ?> selected
                                <?php endif; ?> value="<?php echo e($dp->id); ?>"-><?php echo e($dp->title); ?></option>
                    ...
                    <tr>
                        ...
                        <td><input name="photo" type="file" /></td>
                            ...
                            <img width="80" src="<?php echo e(asset('storage/'.$data->photo)); ?>" />
                    </tr>
                    <tr>
                        <th>Bio</th>
                    ...
                    <tr>
                        <th>Salary Type</th>
                        <td><input <?php if($data->salary_type=='daily'): ?> checked <?php endif; ?> type="radio" name="salary_type" value="daily" /> Daily
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\resortproject\resources\views/staff/edit.blade.php ENDPATH**/ ?>